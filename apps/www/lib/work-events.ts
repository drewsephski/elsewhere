...
function toolLabel(tool: string, payload: Record<string, unknown>): string | null {
  const tools: Record<string, string> = {
    ...
    github_run_check: "Running checks",
    github_review_publish: "Reviewing changes",
    github_publish_pull_request: "Opening pull request",
    github_resume_pull_request: "Reading review feedback",
    github_get_pull_request_feedback: "Reading review feedback",
    github_update_pull_request: "Updating pull request",
