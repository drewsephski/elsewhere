...
/**
 * OpenAPI / Swagger mark from SVGL (`https://svgl.app/library/swagger.svg`).
 */
export function OpenApiLogo({ className, ...props }: SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 256 256"
    ...
    >
      ...
      />
      <path
        d="M128 12a116 116 0 1 1 0 232 116 116 0 1 1 0-232m0-12a128 128 0 1 0 0 256 128 128 0 0 0 0-256Z"
        fill="#173647"
      />
      <path
