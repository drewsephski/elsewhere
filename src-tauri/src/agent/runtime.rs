...
pub fn build_responses_input_from_messages(messages: &[Message]) -> Result<Vec<serde_json::Value>, AppError> {
...
pub async fn run_agent_chat(deps: AgentLoopDeps, ctx: AgentLoopContext, input: Vec<serde_json::Value>) -> Result<(), AppError> {
