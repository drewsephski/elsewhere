...
#ifndef GPTBOTVMMLIB_SWIFT_H
#define GPTBOTVMMLIB_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GptBotVMMLib",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12GptBotVMMLib19LinuxVirtualMachine")
@interface LinuxVirtualMachine : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

@class VZVirtualMachine;
@interface LinuxVirtualMachine (SWIFT_EXTENSION(GptBotVMMLib)) <VZVirtualMachineDelegate>
- (void)guestDidStopVirtualMachine:(VZVirtualMachine * _Nonnull)virtualMachine;
- (void)virtualMachine:(VZVirtualMachine * _Nonnull)virtualMachine didStopWithError:(NSError * _Nonnull)error;
@end
