...
Use the Codex browser tools (`browser_navigate`, `browser_snapshot`, `browser_click`, `browser_fill`, `browser_take_screenshot`). Prefer accessible names and `apps/www/lib/app-routes.ts` paths.
